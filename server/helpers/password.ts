...
export const generateHashPassword = (password: string): IPersistedPassword => {
...
export const passwordMatch = (persistedPassword: IPersistedPassword, passwordAttempt: string): boolean => {
